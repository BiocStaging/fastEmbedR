...
CACHE_DIR="${CACHE_DIR:-${RESULTS_ROOT}/reviewer_precomputed}"
...
METHODS="${METHODS:-fastEmbedR_pca_cpu,fastEmbedR_opentsne_cpu_full,fastEmbedR_opentsne_cpu_knn,fastEmbedR_umap_cpu_fuzzy_full,fastEmbedR_umap_cpu_fuzzy_knn,fastEmbedR_umap_cpu_binary_full,fastEmbedR_umap_cpu_binary_knn,fastEmbedR_pca_metal,fastEmbedR_opentsne_metal_full,fastEmbedR_opentsne_metal_knn,fastEmbedR_umap_metal_fuzzy_full,fastEmbedR_umap_metal_fuzzy_knn,fastEmbedR_umap_metal_binary_full,fastEmbedR_umap_metal_binary_knn}"
