...
Landmarking accelerated median CPU but not CUDA runs; medians and IQRs are supplementary. \pkg{} is MIT licensed at \url{https://github.com/tkcaccia/fastEmbedR}. Source is frozen at commit \texttt{58e39d5} (full identity in the supplement); an archival DOI will accompany the final release.
